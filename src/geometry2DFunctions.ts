// https://github.com/CodeMason/eurokick-jmegame/blob/master/EuroKickProject/src/sg/games/football/geom/Geometry2DFunctions.java
 ...
 * Geometry functions
 */
export class Geometry2DFunctions {
  ...
  static perspectiveTransformation(config: {
    ...
    return {
      ...
      worldToScreenPoint(position: ReadonlyVector2Like) {
        ...
        const y_dash = (y * a * h) / (b * h + y * (a - b));
        const x_dash = (x / p) * (p - y_dash);
