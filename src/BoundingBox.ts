...
class BoundingBox extends Object {
  constructor(...args) {
    ...
    (
      BoundingBox.prototype.constructor._init ||
      (BoundingBox.prototype.constructor._init = Overload.Create()
        .Add([], function () {
  ...
  Contains(...args) {
    return (BoundingBox.prototype.Contains = Overload.Create()
      ...
      .Add([BoundingSphere], function (sphere) {
        if (
          sphere.Center.X - this.Min.X >= sphere.Radius &&
  ...
  static CreateFromPoints(...args) {
    return (BoundingBox.CreateFromPoints = Overload.Create().Add(
      [TypeList.T(Vector3)],
      function (points) {
        let empty = true;
  ...
  Equals(...args) {
    return (BoundingBox.prototype.Equals = Overload.Create()
  ...
  GetHashCode(...args) {
    return (BoundingBox.prototype.GetHashCode = Overload.Create().Add(
      [],
      function () {
  ...
  Intersects(...args) {
    return (BoundingBox.prototype.Intersects = Overload.Create()
      .Add([BoundingBox], function (box) {
  ...
  ToString(...args) {
    return (BoundingBox.prototype.ToString = Overload.Create().Add(
      [],
      function () {
  ...
  Serialize(...args) {
    ...
    return (BoundingBox.prototype.Serialize = Overload.Create().Add(
      [String],
      function () {
  ...
  static Deserialize(...args) {
    return (BoundingBox.Deserialize = Overload.Create()
