...
export class BoundingSphere {
  ...
  //       },
  //       set: Overload.Create().Add([Vector3], (value) => {
  ...
  //   });
  //   (
  //     BoundingSphere.prototype.constructor._init ||
  //     (BoundingSphere.prototype.constructor._init = Overload.Create()
  //       .Add([], function () {
  ...
  //   return (BoundingSphere.CreateFromFrustum = Overload.Create().Add(
  //     [BoundingFrustum],
  //     function (frustum) {
  ...
  //   return (BoundingSphere.CreateFromPoints = Overload.Create().Add(
  //     [TypeList.T(Vector3)],
  //     function (points) {
  //       let minx = new Vector3(
  //         Number.MAX_VALUE,
  //         Number.MAX_VALUE,
  //         Number.MAX_VALUE
  //       );
  ...
  //   return (BoundingSphere.CreateMerged = Overload.Create().Add(
  //     [BoundingSphere, BoundingSphere],
  //     function (original, additional) {
  //       let ocenterToaCenter = Vector3.Subtract(
  //         additional.Center,
  //         original.Center
  //       );
  ...
  // }
  // Equals(...args) {
  //   return (BoundingSphere.prototype.Equals = Overload.Create()
  ...
  // }
  // GetHashCode(...args) {
  //   return (BoundingSphere.prototype.GetHashCode = Overload.Create().Add(
  //     [],
  //     function () {
  ...
  // }
  // ToString(...args) {
  //   return (BoundingSphere.prototype.ToString = Overload.Create().Add(
  //     [],
  //     function () {
  ...
  //   return (BoundingSphere.prototype.Serialize = Overload.Create().Add(
  //     [String],
  //     function () {
  ...
  //   return (BoundingSphere.Deserialize = Overload.Create()
